    ...
    public partial class ChiTietHDB : Form
    {
        ...
        private void LayDSCTHDB()
        {
            ...
            try
            {
                ...
                //gọi thủ tục từ SQL
                da.SelectCommand.CommandText = "LayDSCTHDB";
                ...
                dgvChiTietHDB.DataSource = dt;
                //đóng chuỗi kết nối
                conn.Close();
                //sử dụng thuộc tính Width và HeaderText để set chiều dài và tiêu đề cho các coloumns
                dgvChiTietHDB.Columns[0].Width = 50;
                dgvChiTietHDB.Columns[0].HeaderText = "Mã HDB";
                dgvChiTietHDB.Columns[1].Width = 110;
                dgvChiTietHDB.Columns[1].HeaderText = "Ma thuoc";
                dgvChiTietHDB.Columns[2].Width = 50;
                dgvChiTietHDB.Columns[2].HeaderText = "So luong";
                dgvChiTietHDB.Columns[3].Width = 50;
                dgvChiTietHDB.Columns[3].HeaderText = "Giam gia";
                dgvChiTietHDB.Columns[4].Width = 100;
                dgvChiTietHDB.Columns[4].HeaderText = "Thanh tien";
            }
            catch (Exception ex)
            {
