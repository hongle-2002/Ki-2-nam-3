    ...
    public partial class CongDung : Form
    {
        ...
        private void LayDSCongDung()
        {
            ...
            try
            {
                ...
                //gọi thủ tục từ SQL
                da.SelectCommand.CommandText = "LayDSCongDung";
                ...
                dgvCongDung.Columns[0].Width = 100;
                dgvCongDung.Columns[0].HeaderText = "Mã cong dung";
                dgvCongDung.Columns[1].Width = 110;
                dgvCongDung.Columns[1].HeaderText = "Tên cong dung";
